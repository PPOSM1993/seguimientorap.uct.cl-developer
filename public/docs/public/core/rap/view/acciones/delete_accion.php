...
$aniv_codigo = isset($_POST['item']) ? $_POST['item'] : '';
$tins_codigo = isset($_POST['tins_codigo']) ? $_POST['tins_codigo'] : '';
$aniv_anho_cohorte = isset($_POST['aniv_anho_cohorte']) ? $_POST['aniv_anho_cohorte'] : '';
$aniv_descripcion = isset($_POST["aniv_descripcion"]) ? $_POST["aniv_descripcion"] : '';
$aniv_observacion = isset($_POST["aniv_observacion"]) ? $_POST["aniv_observacion"] : '';
$usuario_mod = 'usuarioprueba';

try {
    $consulta =
        "EXEC CELUCT.rap.MantenedorAcciones
            @accion = 'eliminar',

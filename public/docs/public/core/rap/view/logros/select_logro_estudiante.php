    ...
    if (count($logros) > 0) {
        foreach ($logros as $logro) {
            ...
            echo '<tr class="text-uppercase" role="row">
                    ...
                    <td class="text-left">' . $logro['REGISTRO'] . '</td>
                    <td class="text-left">' . $logro['carr_codigo'] . "-" . $logro['carr_nombre'] . '</td>
                    <td class="text-left">' . $logro['plan_codigo'] . '</td>
                    <td class="text-left">' . $logro['tins_nombre'] . '</td>
                    <td class="text-center">
                        <a class="btn btn-success text-center" onclick="" href="./docs/public/core/rap/view/logros/excel.php">
